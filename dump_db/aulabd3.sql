...
-- Copiando estrutura para tabela aula_bd3.categoria
CREATE TABLE IF NOT EXISTS `categoria` (
  `ID_CAT` int(11) NOT NULL AUTO_INCREMENT,
  `NOME_CAT` varchar(10) DEFAULT NULL,
  `DISPONIVEL_CAT` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`ID_CAT`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Exportação de dados foi desmarcado.

-- Copiando estrutura para tabela aula_bd3.pessoa
...
-- Copiando estrutura para tabela aula_bd3.produto
...
-- Copiando estrutura para tabela aula_bd3.venda
CREATE TABLE IF NOT EXISTS `venda` (
  ...
  CONSTRAINT `venda_ibfk_1` FOREIGN KEY (`ID_PESSOA`) REFERENCES `pessoa` (`ID_PESSOA`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Exportação de dados foi desmarcado.

-- Copiando estrutura para tabela aula_bd3.venda_item
CREATE TABLE IF NOT EXISTS `venda_item` (
  ...
  CONSTRAINT `venda_item_ibfk_1` FOREIGN KEY (`ID_VENDA`) REFERENCES `venda` (`ID_VENDA`),
  CONSTRAINT `venda_item_ibfk_2` FOREIGN KEY (`ID_PRODUTO`) REFERENCES `produto` (`ID_PRODUTO`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
-- Copiando estrutura para tabela phpmyadmin.pma__bookmark
...
-- Copiando estrutura para tabela phpmyadmin.pma__central_columns
...
-- Copiando estrutura para tabela phpmyadmin.pma__column_info
...
-- Copiando estrutura para tabela phpmyadmin.pma__designer_settings
...
-- Copiando estrutura para tabela phpmyadmin.pma__export_templates
...
-- Copiando estrutura para tabela phpmyadmin.pma__favorite
...
-- Copiando estrutura para tabela phpmyadmin.pma__history
...
-- Copiando estrutura para tabela phpmyadmin.pma__navigationhiding
...
-- Copiando estrutura para tabela phpmyadmin.pma__pdf_pages
...
-- Copiando estrutura para tabela phpmyadmin.pma__recent
...
-- Copiando estrutura para tabela phpmyadmin.pma__relation
...
-- Copiando estrutura para tabela phpmyadmin.pma__savedsearches
...
-- Copiando estrutura para tabela phpmyadmin.pma__table_coords
...
-- Copiando estrutura para tabela phpmyadmin.pma__table_info
...
-- Copiando estrutura para tabela phpmyadmin.pma__table_uiprefs
...
-- Copiando estrutura para tabela phpmyadmin.pma__tracking
...
-- Copiando estrutura para tabela phpmyadmin.pma__userconfig
...
-- Copiando estrutura para tabela phpmyadmin.pma__usergroups
...
-- Copiando estrutura para tabela phpmyadmin.pma__users
